...
const update_onyxia = __importStar(__nccwpck_require__(1093));
exports.actions = {
    update_onyxia
};
...
function _run(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const { github_token, owner, repo, sha, automatic_commit_author_email, keycloak_apps, onyxia_apps, version, log = () => { } } = params;
        ...
        (0, gitClone_1.gitClone)({
            ...
            "action": ({ repoPath }) => __awaiter(this, void 0, void 0, function* () {
                onyxia_apps.split(" ").forEach(appName => {
                    const chartPath = (0, path_1.join)(repoPath, "apps", appName, "Chart.yaml");
                    const chart = yaml_1.default.parseDocument(fs.readFileSync(chartPath, "utf8"));
                    {
                        (0, assert_1.assert)(chart.getIn(["dependencies", 0, "name"]) === "onyxia", "Expect the first dependency to be onyxia");
                        const currentVersion = chart.getIn(["dependencies", 0, "version"]);
                        (0, assert_1.assert)(typeof currentVersion === "string", "Current version should be a string");
                        if (SemVer_1.SemVer.compare(SemVer_1.SemVer.parse(currentVersion), SemVer_1.SemVer.parse(version)) === 0) {
                ...
                keycloak_apps.split(" ").forEach(appName => {
                    const valuesYamlFilePath = (0, path_1.join)(repoPath, "apps", appName, "values.yaml");
                    let valuesYamlRaw = fs.readFileSync(valuesYamlFilePath).toString("utf8");
                    valuesYamlRaw = (0, updateUrl_1.updateUrl)({
                        "text": valuesYamlRaw,
                        "getUrl": tagName => `https://github.com/InseeFrLab/onyxia/releases/download/${tagName}/`,
                        "tagName": `v${SemVer_1.SemVer.stringify(SemVer_1.SemVer.parse(version))}`
                    });
                    fs.writeFileSync(valuesYamlFilePath, Buffer.from(valuesYamlRaw, "utf8"));
                });
                return {
                    "doCommit": true,
                    "doAddAll": false,
...
const actions_1 = __nccwpck_require__(5167);
const inputHelper_1 = __nccwpck_require__(6078);
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield actions_1.actions[(0, inputHelper_1.getActionName)()].run();
    }
    catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getActionName = exports.getActionParamsFactory = exports.getInputDefault = exports.getInputDescription = exports.inputNames = void 0;
const core = __importStar(__nccwpck_require__(2186));
const assert_1 = __nccwpck_require__(8078);
exports.inputNames = [
    "action_name",
...
function gitClone(params) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield globalMutex.runExclusive(() => __awaiter(this, void 0, void 0, function* () {
            ...
            isFirstCall = false;
            yield fs.promises.rm(cacheDir, { "recursive": true, "force": true });
            yield fs.promises.mkdir(cacheDir, { "recursive": true });
        }));
...
exports.ErrorNoBranch = ErrorNoBranch;
